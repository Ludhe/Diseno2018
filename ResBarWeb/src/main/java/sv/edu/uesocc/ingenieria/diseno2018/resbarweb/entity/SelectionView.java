...
public class SelectionView implements Serializable {
    ...
    @PostConstruct
    public void init() {
        cars1 = service.createCars(6);
        cars2 = service.createCars(6);
        cars3 = service.createCars(6);
        cars4 = service.createCars(6);
        cars5 = service.createCars(6);
        cars6 = service.createCars(6);
    }
